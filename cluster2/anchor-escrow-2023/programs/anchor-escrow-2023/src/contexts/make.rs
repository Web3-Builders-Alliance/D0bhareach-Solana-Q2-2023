...
pub struct Make<'info> {
    ...
    #[account(
        ...
        associated_token::authority = maker // what exactly authority do??? I know it's an owner
    )]
    ...
    // if mint exista I probably just put it PubKeys here???
    ...
    #[account(
        ...
        token::authority = auth // OK. auth can chainge this account. Right???
    )]
